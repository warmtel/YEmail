...
public class AccountSetupBasics extends Activity
    ...
    private final static int DIALOG_ADD_ACCOUNT = 3;
    ...
    private final static int DEFAULT_ACCOUNT_CHECK_INTERVAL = 10;
...
//              MessageList.actionHandleAccount(this, accountId, Mailbox.TYPE_INBOX);
        ...
        try {
            ...
            if(c.getCount() > Global.addAccountCount){
            	Global.addAccountCount = c.getCount();
            }
            if(c.getCount() >= Global.addAccountCount){
            	showDialog(DIALOG_ADD_ACCOUNT);
            	return;
            }
        } finally {
            if (c != null) {
...
*/
    ...
    public Dialog onCreateDialog(int id) {
        if (id == DIALOG_NOTE) {
            ...
            .setMessage(getString(R.string.account_duplicate_dlg_message_fmt,
                    ...
                    .create();
        }else if(id == DIALOG_ADD_ACCOUNT){
        	return new AlertDialog.Builder(this)
            .setIcon(android.R.drawable.ic_dialog_alert)
            .setTitle(R.string.account_add_dlg_title)
            .setMessage(getString(R.string.account_add_dlg_message_fmt,
                    Global.addAccountCount))
                    .setPositiveButton(R.string.confirm,
                            new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                        	finish();
                            dismissDialog(DIALOG_ADD_ACCOUNT);
                        }
                    })
                    .create();
        }
    ...
    private void finishAutoSetup() {
        ...
        try {
            ...
            Logs.d(Logs.LOG_MessageView, "outgoingUri :"+outgoingUri.toString());
