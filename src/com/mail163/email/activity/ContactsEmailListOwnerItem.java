 ...
 */
public class ContactsEmailListOwnerItem extends RelativeLayout {
    ...
    private ContactsEmailOwner.MessageEmailListAdapter mAdapter;
    ...
    public ContactsEmailListOwnerItem(Context context) {
        super(context);
    }

    public ContactsEmailListOwnerItem(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ContactsEmailListOwnerItem(Context context, AttributeSet attrs, int defStyle) {
     ...
     */
    public void bindViewInit(ContactsEmailOwner.MessageEmailListAdapter adapter, boolean allowBatch) {
        mAdapter = adapter;
