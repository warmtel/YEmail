...
public class Recorder implements OnCompletionListener, OnErrorListener {
    ...
    public static final int RECORDING_STATE_PREPARE = 3;
    public static final int RECORDING_STATE_RECOREDING = 4;
    public static final int RECORDING_STATE_OVER = 5;
    ...
    public void setSampleFile(File mFile) {
        mSampleFile = mFile;
    }
    /**
    ...
    public void startRecording(File sampleDir,int outputfileformat, String extension, Context context) {
        stop();
        Log.e(TAG, "startRecording mSampleFile :"+mSampleFile);
        ...
        setState(RECORDING_STATE_PREPARE);
