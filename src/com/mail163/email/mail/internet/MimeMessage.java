...
public class MimeMessage extends Message {
    ...
    public String getPriority() throws MessagingException {
        return MimeUtility.unfoldAndDecode(getFirstHeader("X-Priority"));
    }
    @Override
    public void setPriority(String priority) throws MessagingException {
        final int HEADER_NAME_LENGTH = 9;     // "X-Priority: "
        setHeader("X-Priority", MimeUtility.foldAndEncode2(priority, HEADER_NAME_LENGTH));
    }
    /**
    ...
    public void setBody(Body body) throws MessagingException {
        this.mBody = body;
        if (body instanceof com.mail163.email.mail.Multipart) {
            com.mail163.email.mail.Multipart multipart = ((com.mail163.email.mail.Multipart)body);
